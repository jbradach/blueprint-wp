...
//http://www.smashingmagazine.com/2009/08/10-useful-wordpress-hook-hacks/ RAW
/**
 * Theme setup
 */
function setup() {
...
//  add_theme_support('post-formats', ['aside', 'gallery', 'link', 'image', 'quote', 'video', 'audio']);
    add_theme_support('post-formats', ['aside','link','quote']);

  // Enable HTML5 markup support
  // http://codex.wordpress.org/Function_Reference/add_theme_support#HTML5
  add_theme_support('html5', ['caption', 'comment-form', 'comment-list', 'gallery', 'search-form']); //comment-form
...
function widgets_init() {
  register_sidebar([
    ...
    'id'            => 'sidebar-primary',
    'before_widget' => '<section class="panel panel-info widget %1$s %2$s">',
    'after_widget'  => '</section>',
    'before_title'  => '<div class="panel-heading"><h3 class="panel-title">',
    'after_title'   => '</h3></div><div class="panel-body list-unstyled">'
  ]);
